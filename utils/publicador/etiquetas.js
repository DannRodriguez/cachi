...
export const ACCESIBILIDAD_COTAS =
  "Da clic en el ícono de accesibilidad para visualizar las acotaciones correspondientes a la tabla.";
export const ULTIMO_CORTE = "Último corte:";
export const SELECCIONA = "Selecciona ";
export const EL_LISTADO = "Selecciona el listado:";
export const LA_CEDULA = "Selecciona la cédula:";
...
export const ETQ_TIPO_REPORTE = "Tipo de reporte";
export const MSG_CONSENTRADO_NACIONAL =
  "El desglose del concentrado nacional presenta los resultados por entidad.";
